    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            ...
            if (!authRepository.isLoggedIn()) {
                ...
                android.util.Log.w("PanelAlumno", "⚠️ Usuario no autenticado, redirigiendo al login")
                val intent = Intent(this@PanelAlumnoActivityCompose, LoginActivityCompose::class.java)
