...
interface IIARepository {
    ...
    suspend fun estructurarClasePorTiempo(nombreClase: String, descripcion: String, duracion: String, pdfUrl: String?): String
    suspend fun resumirContenidoPdf(nombre: String, descripcion: String, archivoNombre: String): String
    suspend fun generarGuiaPresentacion(nombre: String, descripcion: String, pdfUrl: String?): String
    suspend fun generarEjerciciosParaAlumno(nombre: String, descripcion: String, pdfUrl: String?): String
    suspend fun crearResumenEstudioParaAlumno(nombre: String, descripcion: String, archivoNombre: String): String
